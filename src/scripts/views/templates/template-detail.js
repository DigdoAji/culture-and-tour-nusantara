        ...
        <div class="card-body">
            ...
            <div class="row mt-2 mb-2 pt-4 px-3 px-md-5">
                ...
                <div class="col-md-4 my-auto pt-3 d-flex justify-content-center justify-content-md-end">
                    <a href="${`#/edit-article/${detailArticle.id}`}" onclick="window.scrollTo(0, 0);"><button id="updateArticle" type="button" class="btn btn-primary me-2 fw-bold px-4" tabindex="-1">Update</button></a>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="d-flex justify-content-center justify-content-md-end mt-2 mb-2 pt-4">
                <a href="${`#/edit-event/${detailEvent.id}`}" onclick="window.scrollTo(0, 0);"><button id="updateEvent" type="button" class="btn btn-primary ms-2 fw-bold px-4" tabindex="-1">Update</button></a>
