    ...
    <section id="detail-event">
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="../public/images/lomba-jukung-tradisonal-banjar.png" 
                        ...
                        <div class="card-body py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="user d-flex flex-row align-items-center">
                                    <img src="../public/images/blank-profile.png" width="50" height="50" class="usercomment-img rounded-circle me-3">
